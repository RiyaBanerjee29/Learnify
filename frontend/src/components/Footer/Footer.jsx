...
export function Footer() {
  return (
    <section className="relative overflow-hidden bg-purple-500 py-4">
          ...
          <div className="w-auto p-8">
            <a href="#">
              ...
              <img  src={Logo} className=' w-20 h-20'/>
                <span className="ml-4 text-lg font-bold">Pawsome</span>
              </div>
            </a>
          </div>
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              <li className="p-5  hover:bg-purple-700 rounded-3xl">
                <a className="font-medium text-white " href="#">
                  Privacy Policy
                </a>
              </li>
              <li className="p-5  hover:bg-purple-700 rounded-3xl">
              <a className="font-medium text-white " href="#">  Terms of Service
                </a>
              </li>
              <li className="p-5  hover:bg-purple-700 rounded-3xl">
              <a className="font-medium text-white " href="#"> Return Policy
                </a>
              </li>
              <li className="p-5  hover:bg-purple-700 rounded-3xl">
              <a className="font-medium text-white " href="#"> Contact Us
                </a>
              </li>
            </ul>
          </div>
